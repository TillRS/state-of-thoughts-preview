...
class Message(BaseModel, DictAccessMixin):
	...
	role: Literal[
		MessageRole.ASSISTANT, MessageRole.USER, MessageRole.SYSTEM, MessageRole.TOOL
	] = Field(
		...,
		description=f"""
Role: '{MessageRole.ASSISTANT}', '{MessageRole.USER}', '{MessageRole.SYSTEM}', or '{MessageRole.TOOL}'.
""".strip(),
	)
