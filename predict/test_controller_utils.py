...
from signatures.example_signatures import QuestionField
	...
	styles_json = {
		...
		ActionSpaceJsonKeys.DIMENSION_CHOICES: {
			"Figurative Language": {
				...
				ControllerOutputParameters.PREFIX: "Imagine this:",
			},
			...
			"Formal & Academic": {
				...
				ControllerOutputParameters.PREFIX: "It can be argued that",
			},
		},
	}
	...
	structures_json = {
		...
		ActionSpaceJsonKeys.DIMENSION_CHOICES: {
			"Cause & Effect": {
				...
				ControllerOutputParameters.PREFIX: "As a result,",
			},
			"Contrast": {
				...
				ControllerOutputParameters.PREFIX: "On the other hand,",
			},
		},
	}
...
class TestReturnActionIfSingleOption:
	...
	def test_return_action_if_single_option(
		...
		state = State(
			...
			reasoning={reasoning_field_name: ["First, I need to think about addition."]},
		)
		...
		[
			pytest.param(
				...
				lambda **kwargs: {
					...
					"result": "success",
					ControllerOutputParameters.INTERNAL_REASONING: "Test reasoning",
					ControllerOutputParameters.PREFIX: "Test prefix",
				},
				{},							# tool_args
			...
			pytest.param(
				...
				lambda style, **kwargs: {
					ControllerContinueReasoningChoice.CONTINUE_REASONING: True,
					"style": style,
					ControllerOutputParameters.INTERNAL_REASONING: f"Using {style}",
					ControllerOutputParameters.PREFIX: "",
				},
				{},							# tool_args
...
class TestRemoveDuplicateActionsWithCounts:
	...
	@pytest.mark.parametrize(
		...
		[
			pytest.param(
				...
				[
					(ControllerContinueReasoningChoice.CONTINUE_REASONING, {}, 2),
				],
			...
			pytest.param(
				...
				[
					...
					},
					{
						...
						ControllerActionParameters.ARGUMENTS: {},
						ControllerActionParameters.CONSIDERATIONS: "Different action",
					},
				],
				# expected_combinations
				[
					(ControllerContinueReasoningChoice.CONTINUE_REASONING, {}, 1),
					(ControllerContinueReasoningChoice.FINISH, {}, 1),
				],
				id="no_duplicates",
			),
			pytest.param(
				...
				[
					{
						ControllerActionParameters.ACTION: "select_style",
						ControllerActionParameters.ARGUMENTS: {"style": "A"},
						ControllerActionParameters.CONSIDERATIONS: "1",
					},
					{
						ControllerActionParameters.ACTION: "select_style",
						ControllerActionParameters.ARGUMENTS: {"style": "B"},
						ControllerActionParameters.CONSIDERATIONS: "2",
					},
					{
						ControllerActionParameters.ACTION: "select_style",
						ControllerActionParameters.ARGUMENTS: {"style": "A"},
						ControllerActionParameters.CONSIDERATIONS: "3",
					},
				],
				# expected_combinations
				[
				...
				[
					{
						...
						ControllerActionParameters.ARGUMENTS: {"style": "Formal", "structure": "Cause"},
						ControllerActionParameters.CONSIDERATIONS: "First combo",
					},
					{
						ControllerActionParameters.ACTION: "select_style_structure",
						ControllerActionParameters.ARGUMENTS: {"style": "Formal", "structure": "Contrast"},
						ControllerActionParameters.CONSIDERATIONS: "Different structure",
					},
					{
						ControllerActionParameters.ACTION: "select_style_structure",
						ControllerActionParameters.ARGUMENTS: {"style": "Formal", "structure": "Cause"},
						ControllerActionParameters.CONSIDERATIONS: "Duplicate combo",
					},
					{
						ControllerActionParameters.ACTION: "select_style_structure",
						ControllerActionParameters.ARGUMENTS: {"style": "Formal", "structure": "Cause"},
						ControllerActionParameters.CONSIDERATIONS: "Another duplicate",
					},
				],
				# expected_combinations
				[
	...
	def test_remove_duplicate_actions_with_counts(
		...
		result_map = {}
		for item in result:
			action = item[ControllerActionParameters.ACTION]
			args = item[ControllerActionParameters.ARGUMENTS]
		...
		for expected_tool, expected_params, expected_count in expected_combinations:
			...
			actual_count = result_map[key][ControllerOutputParameters.UNIQUE_ACTION_RESPONSE_COUNT]
...
class TestLoadActionSpaceJson:
	...
	def test_load_valid_json(self, tmp_path: Path) -> None:
		...
		"""
		data = {
			ActionSpaceJsonKeys.DIMENSION_NAME: "My Dimension",
			ActionSpaceJsonKeys.DIMENSION_DEFINITION: "A test dimension.",
			ActionSpaceJsonKeys.DIMENSION_CHOICES: {
	...
	@pytest.mark.parametrize(
		"missing_key",
		[
			ActionSpaceJsonKeys.DIMENSION_NAME,
			ActionSpaceJsonKeys.DIMENSION_DEFINITION,
			ActionSpaceJsonKeys.DIMENSION_CHOICES,
		],
	)
	def test_load_invalid_json(self, tmp_path: Path, missing_key: str) -> None:
		...
		"""
		data = {
			ActionSpaceJsonKeys.DIMENSION_NAME: "Name",
			ActionSpaceJsonKeys.DIMENSION_DEFINITION: "Def",
			ActionSpaceJsonKeys.DIMENSION_CHOICES: {},
		}
...
class TestCreateReasoningInterventionFromChoices:
	...
	def mock_config(self) -> ActionSpaceConfig:
		...
		return ActionSpaceConfig(
			...
			choices={
				"Formal": {
					ControllerOutputParameters.INTERNAL_REASONING: "Result: Formal.",
					ControllerOutputParameters.PREFIX: "Therefore,",
				},
				"Informal": {
					ControllerOutputParameters.INTERNAL_REASONING: "Result: Informal.",
					# No prefix
				},
			},
		)
	...
	def test_multiple_configs(self, mock_config: ActionSpaceConfig) -> None:
		...
		config2 = ActionSpaceConfig(
			...
			choices={
				"Serious": {
					ControllerOutputParameters.INTERNAL_REASONING: "So serious.",
				}
			},
		)
